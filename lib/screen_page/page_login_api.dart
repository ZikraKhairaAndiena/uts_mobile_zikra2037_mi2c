...
import 'package:uts_zikra2037/screen_page/page_bottom_navigation.dart';
import 'package:uts_zikra2037/screen_page/page_register_api.dart';
  ...
  Future<ModelLogin?> registerAccount() async {
    try {
      ...
      http.Response response = await http.post(
        Uri.parse('http://192.168.100.110/uts_mobile/login.php'),
        body: {
